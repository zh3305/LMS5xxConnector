...
namespace LMS5xxConnector.Telegram
{
    ...
    public class TelegramContent
    {
        ...
        [Subtype("CommandTypes", CommandTypes.Swa, typeof(SwaCommandContainer), BindingMode = BindingMode.OneWay)]
        [Subtype("CommandTypes", CommandTypes.Sea, typeof(SeaCommandContainer), BindingMode = BindingMode.OneWay)]
